...
"""
ENHANCED test_13_nudged_elastic_band.py WITH DEBUG LOGGING
========================================

This is an enhanced version of test_13_nudged_elastic_band.py that demonstrates how to enable
...
Usage:
------
python test_13_nudged_elastic_band_with_logging.py
